...
echo -e "${M}\n\t\tC O M A N D O S  V A L I D O S"
echo -e "${M}===-===-===-===-===-===-===-===-===-===-===-===-===-===-===-===-===-"
echo -e "  ${C}ayuda${W}      - Tu guía rápida por este universo de comandos"
echo -e "  ${C}infosis${W}    - ¿Curioso sobre tu PC? Descubre sus secretos aquí"
